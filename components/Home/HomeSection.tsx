        ...
        <div className="max-w-5xl mx-auto space-y-8 md:py-36 pb-14">
          <div className="text-left space-y-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-8 md:gap-4">
              <h1 className="text-5xl md:text-6xl font-medium text-pretty leading-none">
                <span className="text-lime-300">Software</span> <br />
                Developer
              </h1>
          ...
          <div className="text-right mt-28">
            ...
            <div className="flex text-left">
              <div className="flex-3 max-h-fit">
                <LetterGlitch
              ...
              <div className="flex-3 flex flex-col justify-evenly min-h-full flex-wrap ml-3">
                <Accordion />
              </div>
            </div>
          </div>
