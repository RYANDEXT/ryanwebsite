                        ...
                        <div className="flex items-center px-3">
                            ...
                            >
                                <div className="grow min-w-0">
                                    ...
                                    <div className="py-1 text-sm max-w-sm overflow-hidden mr-3 text-gray-500 flex flex-wrap gap-2">
                                        {item.tags.map((tag) => {
                                            return (
                                                <div
                            ...
                            <div className="flex gap-2 ml-auto flex-shrink-0">
                                <Link
                                    ...
                                    target="_blank"
                                    aria-label="Github"
                                    className="size-14 flex-shrink-0 flex justify-center items-center text-gray-100 hover:text-white transition duration-300 ease-in-out border border-white/10 p-3 rounded-xl hover:bg-black/10 hover:shadow-[0px_0px_17px_rgba(187,244,81,1)] hover:border-lime-300"
                                >
                                    <Image
